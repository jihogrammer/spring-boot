package dev.jihogrammer.product.adaptor.in.web.validation;
...
@Component
public class ProductRegisterPayloadValidator implements Validator {

    @Override
    public boolean supports(@NonNull final Class<?> clazz) {
        return ProductRegisterPayload.class.isAssignableFrom(clazz);
    }

    @Override
    public void validate(@NonNull final Object target, @NonNull final Errors errors) {
        var request = (ProductRegisterPayload) target;
